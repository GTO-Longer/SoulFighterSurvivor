...
{
    public class LegendaryWizardEquipmentAnvil : Equipment
    {
        
        public LegendaryWizardEquipmentAnvil() : base("LegendaryWizardEquipmentAnvil")
        {
            ActiveSkillEffective += () =>
            {
                ...
                var targetEquipments = EquipmentManager.Instance.equipmentList.FindAll(equipment =>
                    equipment.usageTypes.Contains(UsageType.Wizard) &&
