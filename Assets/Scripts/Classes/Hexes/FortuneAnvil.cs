...
namespace Classes.Hexes
{
    public class FortuneAnvil : Hex
    {
        ...
        public override void OnHexGet(Entity entity)
        {
            ...
            EquipmentManager.Instance.GetEquipment("LegendaryFighterEquipmentAnvil")._cost -= 750;
            EquipmentManager.Instance.GetEquipment("LegendaryShooterEquipmentAnvil")._cost -= 750;
            EquipmentManager.Instance.GetEquipment("LegendaryAssassinEquipmentAnvil")._cost -= 750;
            EquipmentManager.Instance.GetEquipment("LegendaryWizardEquipmentAnvil")._cost -= 750;
        }
