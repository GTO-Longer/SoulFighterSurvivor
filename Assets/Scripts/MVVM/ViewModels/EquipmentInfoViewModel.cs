            ...
            foreach (var kv in equipment.equipmentAttributes)
            {
                ...
                switch (kv.Key)
                {
                    ...
                    case EquipmentAttributeType.maxHealthPoint:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "MaxHealthPointIcon");
                        break;
                    ...
                    case EquipmentAttributeType.maxMagicPoint:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "MaxMagicPointIcon");
                        break;
                    ...
                    case EquipmentAttributeType.attackSpeed:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "AttackSpeedIcon");
                        break;
                    ...
                    case EquipmentAttributeType.attackDamage:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "AttackDamageIcon");
                        break;
                    ...
                    case EquipmentAttributeType.abilityPower:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "AbilityPowerIcon");
                        break;
                    ...
                    case EquipmentAttributeType.abilityHaste:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "AbilityHasteIcon");
                        break;
                    ...
                    case EquipmentAttributeType.attackDefense:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "AttackDefenseIcon");
                        break;
                    ...
                    case EquipmentAttributeType.magicDefense:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "MagicDefenseIcon");
                        break;
                    ...
                    case EquipmentAttributeType.attackPenetration:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "AttackPenetrationIcon");
                        break;
                    ...
                    case EquipmentAttributeType.magicPenetration:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "MagicPenetrationIcon");
                        break;
                    ...
                    case EquipmentAttributeType.criticalRate:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "CriticalRateIcon");
                        break;
                    case EquipmentAttributeType.criticalDamage:
                        entryContent = $"<color=#FFA347>+{kv.Value:P0}暴击伤害</color>";
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "CriticalDamageIcon");
                        break;
                    case EquipmentAttributeType.movementSpeed:
                        entryContent = $"<color=#FFFFFF>+{kv.Value:F0}移动速度</color>";
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "MovementSpeedIcon");
                        break;
                    ...
                    case EquipmentAttributeType.omnivamp:
                        ...
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "OmniVampIcon");
                        break;
                    case EquipmentAttributeType.lifeSteal:
                        entryContent = $"<color=#FF6666>+{kv.Value:P0}生命偷取</color>";
                        entryList[^1].transform.Find("EntryIcon").GetComponent<Image>().sprite = ResourceReader.ReadIcon("Attributes", "LifeStealIcon");
                        break;
                    default:
