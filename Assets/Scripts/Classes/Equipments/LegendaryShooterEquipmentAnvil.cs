...
{
    public class LegendaryShooterEquipmentAnvil : Equipment
    {
        
        public LegendaryShooterEquipmentAnvil() : base("LegendaryShooterEquipmentAnvil")
        {
            ActiveSkillEffective += () =>
            {
                ...
                var targetEquipments = EquipmentManager.Instance.equipmentList.FindAll(equipment =>
                    equipment.usageTypes.Contains(UsageType.Shooter) &&
